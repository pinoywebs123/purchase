                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">ITEM INFORMATIONS</h6>
                        ...
                        <div class="card-body">
                            <form action="{{route('admin_create_item_check')}}" method="POST" enctype="multipart/form-data">
                            	...
                            	<div class="row">
                            		...
                            		<div class="col-lg-4">
                            			<div class="form-group">
                            				 <input type="text" name="connection_type" class="form-control" placeholder="CONNECTION TYPE">
                            			</div>
                            		</div>
                            	</div>
                            	<div class="row">
                            		<div class="col-lg-4">
                            			<div class="form-group">
                            				 <input type="text" name="country_origin" class="form-control" placeholder="COUNTRY OF ORIGIN">
                            			</div>
                            		</div>
                            		<div class="col-lg-4">
                            			<div class="form-group">
                            		...
                            		<div class="col-lg-4">
                            			<div class="form-group">
                            				 <input type="text" name="inches" class="form-control" placeholder="INCHES">
                            			</div>
                            		</div>
                            	</div>
                            	<div class="row">
                            		...
                            		<div class="col-lg-4">
                            			<div class="form-group">
                            				 <input type="text" name="thickness" class="form-control" placeholder="THICKNESS">
                            			</div>
                            		</div>
                            		<div class="col-lg-4">
                            			<div class="form-group">
                            	...
                            	<div class="row">
                            		...
                            		<div class="col-lg-4">
                            			<div class="form-group">
                            				 <input type="text" name="discounted_price" class="form-control" placeholder="DISCOUNTED PRICE">
                            			</div>
                            		</div>
                            	</div>
